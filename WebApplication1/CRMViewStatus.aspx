<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMViewStatus.aspx.cs" Inherits="WebApplication1.CRM_View_Status" %>
                ...
                <table cellspacing="0" class="auto-style10">
                    <tr>
                        <td class="auto-style12">
                            <asp:Label ID="Label13" runat="server" Text="Complain No." Font-Bold="True"></asp:Label>
                        </td>
                        <td class="auto-style13">
                            <asp:DropDownList ID="ddlcomplainnum" runat="server" Height="21px" OnSelectedIndexChanged="ddlcomplainnum_SelectedIndexChanged" Width="173px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style14" colspan="2">
                            <asp:GridView ID="GridView1" runat="server" Height="219px" Width="478px">
                            </asp:GridView>
                        </td>
