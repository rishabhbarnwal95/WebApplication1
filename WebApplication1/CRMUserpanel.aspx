<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMUserpanel.aspx.cs" Inherits="WebApplication1.CRM_User" %>
...
<body>
    ...
    <table cellspacing="0" class="auto-style3" border="1">
        <tr class="tdformat">
            <td width="250px">
              <center>
                  <asp:LinkButton ID="lbtncomplainregistration" runat="server" OnClick="lbtncomplainregistration_Click" Font-Bold="True" ForeColor="White">Complain Registration</asp:LinkButton>
                </center>
            </td>
            
            <td width="250px">
               <center> 
                   <asp:LinkButton ID="lbtnviewstatus" runat="server" OnClick="lbtnviewstatus_Click" Font-Bold="True" ForeColor="White">View Status</asp:LinkButton>
                </center>
            </td>
            <td width="250px">
                <center>
                    <asp:LinkButton ID="lbtnfeedback" runat="server" OnClick="lbtnfeedback_Click" Font-Bold="True" ForeColor="White">Feedback</asp:LinkButton>
                </center>
            </td>
            <td width="250px">
                <center>
