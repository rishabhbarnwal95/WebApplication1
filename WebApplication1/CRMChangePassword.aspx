<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMChangePassword.aspx.cs" Inherits="WebApplication1.CRMChangePassword" %>
                ...
                <asp:Label ID="lblMessage" runat="server" Text="Label"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="lblmatchpassword" runat="server" Text="Label"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style11">&nbsp;</td>
                        <td>
                            <asp:Button ID="btnchange" runat="server" OnClick="btnchange_Click" Text="Change" BackColor="#FF9966" BorderStyle="None" Font-Bold="True" ForeColor="White" Height="27px" Width="85px" />
                        </td>
                    </tr>
                </table>
            </td>
